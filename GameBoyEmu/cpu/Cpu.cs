...
namespace GameBoyEmu.CpuNamespace
{
    ...
    public class Cpu
    {
        ...
        private int _incrementCycles = 0;
        ...
        public Cpu(Memory memory, InterruptsManager interrupts, Timers timers)
        {
        ...
        public void Decode()
        {
            ...
            try
            {
                ...
                {
                    instruction?.Execute();
                    _incrementCycles += instruction?.Cycles ?? 0;
                    _timers.Tick(_incrementCycles);
                    _incrementCycles = 0;
                }
                else
                {
